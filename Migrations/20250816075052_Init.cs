        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PERatio = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    DividendYield = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TriggerValue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "ad8a089d-5ba2-4bd1-834e-70bb5b5d3cee", null, "Admin", "ADMIN" },
                    { "bd2be6a6-6687-45e1-b299-f244873a04c0", null, "User", "USER" }
                });

            migrationBuilder.InsertData(
                table: "Stocks",
                columns: new[] { "Id", "CompanyName", "Country", "CurrentPrice", "DividendYield", "Industry", "IsActive", "LastDiv", "LastUpdated", "MarketCap", "PERatio", "Purchase", "Symbol" },
                values: new object[,]
                {
                    { 1, "Apple Inc.", "US", 175.25m, 0.55m, "Technology", true, 0.96m, new DateTime(2025, 8, 16, 14, 50, 51, 953, DateTimeKind.Local).AddTicks(1579), 2800000000000L, 28.5m, 150.00m, "AAPL" },
                    { 2, "Alphabet Inc.", "US", 2750.50m, 0.00m, "Technology", true, 0.00m, new DateTime(2025, 8, 16, 14, 50, 51, 953, DateTimeKind.Local).AddTicks(1629), 1800000000000L, 25.2m, 2500.00m, "GOOGL" },
                    { 3, "Microsoft Corporation", "US", 325.75m, 0.84m, "Technology", true, 2.72m, new DateTime(2025, 8, 16, 14, 50, 51, 953, DateTimeKind.Local).AddTicks(1641), 2400000000000L, 27.8m, 300.00m, "MSFT" }
                });
